...
path_sonido               <- "INPUT/Data/TODO/sonido.json"
...
json_data5 <- fromJSON(file = path_sonido)
...
df_sonidos_limpia             <- aplanar_coord_point(json_data5)
...
write_json(df_sonidos_limpia,
           "OUTPUT/JSON_Planos/Sonidos_flat.json",
           pretty = TRUE, auto_unbox = TRUE)
